...
2. Valuation Rate of items are recalculated based on new landed cost. Read more about valuation at [Item Valuation FIFO and Moving Average](/user-guide/stock/item-valuation-fifo-and-moving-average).![Purchase Receipt Stock Ledger Entries](assets/erpnext_org/images/erpnext/purchase_receipt_stock_ledger_entries.png)
