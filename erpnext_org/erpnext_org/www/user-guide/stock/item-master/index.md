...
## Item Properties
  ...
  * **Item Code:** Item Code is a short-form to denote your Item. If you have very few Items, it is advisable to keep the Item Name and the Item Code same. This helps new users to recognise and update Item details in all transactions. In case you have lot of Items with long names and the list runs in hundreds, it is advisable to code. To understand naming Item codes see [Item Codification](/user-guide/stock/item-master/item-codification)
  * **Item Group:** Item Group is used to categorize an Item under various criterias like products, raw materials, services, sub-assemblies, consumables or all Item groups. Create your default Item Group list under Setup> Item Group and pre-select the option while filling your New Item details under [Item Group](/user-guide/stock/item-group)
...
cannot change it after you have made any stock entry.
  ...
  * [Discussion on Serialized Inventory](/user-guide/stock/serialized-inventory)  
...
Visit [Manufacturing](/user-guide/manufacturing) and [Website ](/user-guide/website)to understand these topics in detail.

To list your products on the website and understand this process in detail,
visit [Product Listing On Website](/user-guide/website/add-products-to-website)
